/*
The code below was modified from https://github.com/ziutek/telnet.
Copyright (c) 2013, Michal Derkacz
For more information, see telnetclient.LICENSE.
*/

// Package tcp provides simple interfaces for interacting with TCP sockets
// and protocols
package tcp

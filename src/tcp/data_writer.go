// The code in this file is used under the MIT License.
// Attribution: github.com/reiver/go-telnet/data_writer.go
// This code been slightly modified from its original format.
// This file also relies on reiver's go-oi package, which may
// Later be rewritten to be included natively in this program
// In order to get rid of the external dependency.
